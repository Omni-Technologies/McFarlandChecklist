...
// INSTRUCTIONS:
// To add a new checklist, simply add a new entry to this object.
// The key (e.g., "McFarland") will be the name that appears in the dropdown.
// The value should be the complete checklist object, following the same format.

const ALL_CHECKLISTS = {
  "McFarland": {
    "projectName": "McFarland Public Safety Center",
    "devices": [
      // Detectors
  ...
  "HQ": {
    "projectName": "Omni Technologies HQ",
    "devices": [
      { "loop": 1, "address": 1, "model": "PS", "deviceType": "Smoke Verified", "serialNumber": "1111111111", "messages": "LOBBY SMOKE DETECTOR" },
      { "loop": 1, "address": 2, "model": "278", "deviceType": "Pull Station", "serialNumber": "2222222222", "messages": "LOBBY PULL STATION BY FRONT DOOR" },
      { "loop": 1, "address": 3, "model": "HRS", "deviceType": "Heat ROR", "serialNumber": "3333333333", "messages": "IT CLOSET HEAT DETECTOR" }
    ]
  }
};
